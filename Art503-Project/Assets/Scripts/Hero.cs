...
//-------ANIMATIONS----------
    ...
    public bool toRanger = true;
    public bool toMage = false;
    public bool toTank = false;
    public bool toRogue = false;


    // Animation - Ranger
    public static Animator rangerAnimator;
    ...
    const string TANK_IDLE = "Tank_Idle";
    const string ROGUE_IDLE = "Rogue_Idle";
